                ...
                <div class="bg-gray-800 p-4 rounded-lg">
                    ...
                    <div class="flex flex-start flex-col gap-2">
                        <div class="flex items-center gap-2">
                            ...
                            @endphp
                            <p class="text-sm {{ $statusClass }} w-fit rounded-md p-2">Status:
                        ...
                        <p class="text-sm text-white p-2 rounded-md w-fit mt-4">
                            {{ $jobApplication->aiGeneratedFeedback }}</p>
                    </div>
                </div>
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="text-lg text-white/70">{{ $application->jobVacancy->company->name }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="text-white/70">
                                            ...
                                            ${{ number_format($application->jobVacancy->salary, 2) }}
                                        </span>
                                    ...
                                    <div class="flex items-center gap-2 text-white/70">
                                        ...
                                        <a href="{{ Storage::disk('cloud')->url($application->resume->fileUri) }}"
                                            target="_blank" class="text-blue-400 hover:underline ml-2">
                                            View Resume
                                        </a>
                                    </div>
                                </div>
